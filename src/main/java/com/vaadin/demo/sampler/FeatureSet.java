...
import com.vaadin.demo.sampler.features.dragndrop.DragDropHtml5ToFromDesktop;
...
import com.vaadin.demo.sampler.features.tabsheets.TabSheetKeyboard;
 ...
 * 'tree'.
 * <p>
 * Each set is implemented as its own class to facilitate linking to sets in the
 * same way as linking to individual features.
 * </p>
 * 
 */
...
public class FeatureSet extends Feature {
    ...
    public static class Panels extends FeatureSet {
        public Panels() {
            super(
                    "Panels",
                    "Panels",
                    "Panel is a simple container that supports scrolling.<br/>Its internal layout (by default VerticalLayout) can be configured or exchanged to get desired results. Components that are added to the Panel will in effect be added to the layout.",
                    new Feature[] {
                            //
                            new PanelBasic(), //
                            new PanelLight(), //
    ...
    public static class Embedding extends FeatureSet {
        public Embedding() {
            super(
                    "Embedding",
                    "Embedding",
                    "Adding non-textual content to your applications. Embedded components may have an alternate textual representation for accessibility purposes.",
                    new Feature[] {
                            //
                            new ImageEmbed(), //
                            new FlashEmbed(), //
        ...
        public DragDrop() {
            super(
                    ...
                    new Feature[] {
                            ...
                            new DragDropHtml5ToFromDesktop(), //
                    });
        }
    }
    ...
    public static class Themes extends FeatureSet {
        ...
        public Themes() {
            super("Themes", "Themes", "", new Feature[] {
