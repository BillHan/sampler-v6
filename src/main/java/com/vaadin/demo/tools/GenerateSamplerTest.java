...
public class GenerateSamplerTest {
    ...
    private static String NEXT_BUTTON = "vaadin=sampler::PID_SnextSample";
    private static String TOGGLE_TREE = "vaadin=sampler::PID_StreeVisibilitySwitch";
    private static String HOME_BUTTON = "vaadin=sampler::PID_ShomeButton";
    ...
    public static void main(String[] args) {
        ...
        FeatureSet samplerFeatureSet = com.vaadin.demo.sampler.FeatureSet.FEATURES;
        writeFeatureSet(script, samplerFeatureSet, false);

        test.addComment("Start over from the main page");
        test.addCmd("mouseClick", HOME_BUTTON, "1,1");
